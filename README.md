...
```
docker pull antlypls/spark:1.6.2
```

## Building the image
```
docker build --rm -t antlypls/spark:1.6.2 .
```
...
```
docker run -it -p 8088:8088 -p 8042:8042 -h sandbox antlypls/spark:1.6.2 bash
```
or
```
docker run -d -h sandbox antlypls/spark:1.6.2 -d
```
